          ...
          {[
            ...
            >
              ...
              <div className="flex gap-2 mt-2 xl:mt-0">
                <button className="px-3 py-1 text-white bg-[#034a9c] hover:bg-[#022f73] focus:bg-[#022f73] active:bg-[#022f73] rounded-xl cursor-pointer">
                  Follow
                </button>
                <button className="px-3 py-1 text-white bg-red-600 hover:bg-[#a00404] focus:bg-[#a00404] active:bg-[#a00404] rounded-xl cursor-pointer">
                  Dismiss
                </button>
              </div>
            </div>
